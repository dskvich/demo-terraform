...
# Create the control plane for the EKS cluster, configure the control plane to use the IAM role you just created,
...
# Create the managed node group, configure the managed node group to use the control plane and IAM
